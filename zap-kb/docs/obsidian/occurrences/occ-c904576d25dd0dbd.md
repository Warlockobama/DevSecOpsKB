...
findingId: "fin-e61cd65eaa3517ea"
generatedAt: "2025-09-18T15:36:59Z"
host: "test.qnod.cms.gov"
id: "occ-c904576d25dd0dbd"
issueId: "fin-e61cd65eaa3517ea"
kind: "observation"
method: "POST"
observationId: "occ-c904576d25dd0dbd"
...
sourceId: "3"
sourceTool: "zap"
url: "https://test.qnod.cms.gov/api/auth/callback"
---

# Observation occ-c904576d25dd0dbd — CWD callback-0dbd

> [!Info]
> Risk: Medium () — Confidence: High

- Definition: [[definitions/10055-csp-wildcard-directive.md|def-10055]]
- Issue: [[findings/fin-e61cd65eaa3517ea.md|fin-e61cd65eaa3517ea]]

**Endpoint:** POST https://test.qnod.cms.gov/api/auth/callback
...
```bash
curl -X POST -H _line: GET https://test.qnod.cms.gov/static/css/main.4bdffaa8.css HTTP/1.1 -H User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/116.0 -H Accept: text/css,*/*;q=0.1 -H Accept-Language: en-US,en;q=0.5 -H Referer: https://test.qnod.cms.gov/ "https://test.qnod.cms.gov/api/auth/callback"
```
...
POST https://test.qnod.cms.gov/api/auth/callback
